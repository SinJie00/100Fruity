      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Sale</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Sale</h6>
        </nav>
        ...
        <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade show active" id="v-pills-item" role="tabpanel" aria-labelledby="v-pills-item-tab">
                ...
                <ul class="nav nav-tabs" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab">Sale</a>
					</li>
				</ul>
				<div class="tab-content">
                <div id="customerSearchTab" class="container-fluid tab-pane active">
					<br>
					<p>Use the grid below to search all details of fruits</p>
					<a class="btn btn-primary" href="configureSalePage.php" >Configure Sale</a> 
                    <br>
...
$(document).ready(function () {
    $.ajax({
        type: "get",
        url: "http://localhost/100Fruity/api/allSales",
        success: function (sale, status, xhr) {
            $('#saleDetailsTableDiv').append(sale);
        },
