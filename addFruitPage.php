      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Add Fruit</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Add Fruit</h6>
        </nav>
		 ...
		 <div class="col-lg-10">
            ...
            <div class="tab-pane fade show active" id="v-pills-item" role="tabpanel" aria-labelledby="v-pills-item-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">New Fruit Details</div>
				  <div class="card-body">
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#fruitImageTab">Upload Image</a>
						</li>
					</ul>					
						...
						<div id="fruitDetailsTab" class="container-fluid tab-pane active">
							...
							<div id="fruitDetailsMessage"></div>
								...
								<div class="form-row">
									...
									<label for="fruitDetailsName">Fruit Name<span class="requiredIcon">*</span></label>
									<input type="text" class="form-control" id="fruitDetailsName" name="fruitDetailsName" placeholder="">
									</div>
								...
								<button type="button" id="addFruit" name="addFruit" class="btn btn-success">Add Fruit</button>
								<button type="reset" class="btn">Clear</button>
								</form>
							</div>
						<div id="fruitImageTab" class="container-fluid tab-pane fade">
							<br>
							<div id="fruitImageMessage"></div>
							<p>You can upload an image for a particular fruit using this section.</p> 
							<p>Please make sure the fruit exist before uploading the image.</p>
							<br>							
							<form name="fruitImageForm" id="fruitImageForm" method="post">
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  <label for="fruitImageItemNumber">Item Number<span class="requiredIcon">*</span></label>
								  <input type="text" class="form-control" name="fruitImageItemNumber" id="fruitImageItemNumber" autocomplete="off">
								  <div id="fruitImageItemNumberSuggestionsDiv" class="customListDivWidth"></div>
								</div>
								<div class="form-group col-md-4">
									<label for="fruitImageItemName">Item Name</label>
									<input type="text" class="form-control" name="fruitImageItemName" id="fruitImageItemName" readonly>
								</div>
							  </div>
							  <br>
							  <div class="form-row">
								  <div class="form-group col-md-7">
									...
									<input type="file" class="form-control-file btn btn-dark" id="fruitImageFile" name="fruitImageFile">
								  </div>
							  </div>
							  <br>
							  <button type="button" id="fruitUpdateImageButton" class="btn btn-primary">Upload Image</button>
...
<script src="api/assets/js/fruit.js">
</script>
</body>
</html>