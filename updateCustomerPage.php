  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      <ul class="navbar-nav">
        ...
        <li class="nav-item" >
          <a class="nav-link active" id="v-pills-customer-tab" href="customerPage.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Update Customer</li>
          </ol>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="customerDetailsMessage"></div>
                     ...
                     <div class="form-group col-md-3">
							<label for="customerDetailsCustomerID">Customer ID<span class="requiredIcon">*</span></label>
							<input type="text" class="form-control invTooltip" id="customerDetailsCustomerID" name="customerDetailsCustomerID" autocomplete="off">
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
							...
							<select id="customerDetailsStatus" name="customerDetailsStatus" class="form-control chosenSelect">
								<?php include('api/customers/statusList.html'); ?>
							</select>
						</div>
					  </div>
					  <div class="form-row">
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  ...
						  <select id="customerDetailsCustomerDistrict" name="customerDetailsCustomerDistrict" class="form-control chosenSelect">
							<?php include('api/customers/districtList.html'); ?>
						  </select>
						</div>
					  </div>					  
					  <button type="button" id="updateCustomerDetailsButton" class="btn btn-primary">Update</button>
					  <button type="button" id="deleteCustomerIDButton" class="btn btn-danger">Delete</button>
...
<script src="api/assets/js/customer.js">
</script>
</body>
</html>