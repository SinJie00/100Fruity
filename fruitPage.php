  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Fruit</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Fruit</h6>
        </nav>
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-10">
            ...
            <div class="card-header">Fruit List</div>
            <div class="card-body">
            <div id="fruitDetailsMessage"></div>
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab">Fruit</a>
                </li>
            </ul>
            ...
            <div id="customerSearchTab" class="container-fluid tab-pane active">
              ...
              <a class="btn btn-primary" href="addFruitPage.php" >Add Fruit</a>
              <a class="btn btn-primary" href="updateFruitPage.php">Update Fruit</a>
              <br>
             <div class="table-responsive" id="fruitDetailsTableDiv"></div>
            </div>
            </div>
            </div> 
            </div> 
...
$(document).ready(function () {
    $.ajax({
        type: "get",
        url: "http://localhost/100Fruity/api/allFruits",
        success: function (fruit, status, xhr) {
            $('#fruitDetailsTableDiv').append(fruit);
        },
