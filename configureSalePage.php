  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" id="v-pills-sale-tab" href="salePage.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Configure Sale</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Configure Sale</h6>
        </nav>
					...
					<form>
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							  ...
							  <input type="text" class="form-control datepicker" id="saleDetailsSaleDate" value="2022-07-28" name="saleDetailsSaleDate" readonly>
						  </div>
					  </div>
					  <div class="form-row">
						<div class="form-group col-md-2">
					  ...
					  <button type="button" id="updateSaleDetailsButton" class="btn btn-primary">Update Sale</button>
					  <button type="button" id="deleteSaleButton" class="btn" style="background-color:red;color:white;">Delete Sale</button>
...
<script src="api/assets/js/sale.js">
</script>
</body>
</html>