...
<body class="g-sidenav-show bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="v-pills-tab" role="tablist" aria-orientation="vertical">
      <ul class="navbar-nav">
        ...
        <li class="nav-item" >
          <a class="nav-link" id="v-pills-fruits-tab" href="fruitPage.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid">
      <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('api/assets/img/curved0.jpg'); background-position-y: 50%;">
        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="api/assets/img/profile.png" alt="profile_image" >
            </div>
          </div>
          <div class="col-auto my-auto">
            <div class="h-100">
              <h5 class="mb-1" id="fullname-1">ALEX</h5>
            </div>
          </div>
      </div>
    </div>
    <div class="container-fluid py-4">
      ...
      <div class="col-12 col-xl-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              <ul class="list-group">
                <li class="list-group-item border-0 ps-0 pt-0 text-sm" id="fullname-2"></li>
                <li class="list-group-item border-0 ps-0 text-sm" id="username"></li>
                <li class="list-group-item border-0 ps-0 text-sm" id="email"></li>
                <li class="list-group-item border-0 ps-0 text-sm" id="status"></li>
              </ul>
            </div>
          </div>
        </div>
...
$(document).ready(function () {
    $.ajax({
        type: "get",
        url: "http://localhost/100Fruity/api/profile",
        success: function (data) {
            var user = JSON.parse(data);
            $('#fullname-1').html(user.fullName);
            $('#fullname-2').html('<strong class="text-dark">Full Name:</strong> &nbsp; '+user.fullName);
            $('#username').html('<strong class="text-dark">Username:</strong> &nbsp; '+user.username);
            $('#email').html('<strong class="text-dark">Email:</strong> &nbsp; '+user.email);
            $('#status').html('<strong class="text-dark">Status:</strong> &nbsp; '+user.status);
        },
