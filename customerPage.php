...
<body class="g-sidenav-show bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-90 h-80 border-radius-lg ">
    <!-- Navbar -->
    ...
    <div class="container-fluid">
		...
		<div class="tab-pane fade show active" id="v-pills-customer" role="tabpanel" aria-labelledby="v-pills-customer-tab">
			<div class="card card-outline-secondary my-4">
				...
				<a class="btn btn-primary" href="addCustomerPage.php" >Add Customer</a>
				<a class="btn btn-primary" href="updateCustomerPage.php" >Update or Delete Customer</a>
				<br><br>
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab">Customer</a>
					</li>
				</ul>
...
$(document).ready(function () {
    $.ajax({
        type: "get",
        url: "http://localhost/100Fruity/api/allCustomers",
        success: function (customers, status, xhr) {
            $('#customerDetailsTableDiv').append(customers);
        },
